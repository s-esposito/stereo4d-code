...
from defgs.rigid_utils import exp_se3
...
class DeformNetwork(nn.Module):
    def __init__(
        ...
        assert (
            not is_blender or not is_6dof
        ), "Blender Deform with 6DoF not supported yet"
        ...
        # init weights and bias of last layers to zero
